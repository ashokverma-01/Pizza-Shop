      ...
      <section className="loginSection signUpSection">
        <div className="row">
          <div className="col-md-8 d-flex align-items-center flex-column justify-content-center part1">
            <h1>
              BEST UX/UI FASHION
              <span className="text-sky"> ECOMMERCE DASHBORD</span> & ADMIN
              PANEL
            </h1>
            ...
            <div className="w-100 mt-4">
              <Link to={"/"}>
                <Button className="goHome btn-blue btn-lg btn-big">
                  {" "}
                  <IoMdHome /> Go to Home
                </Button>
              </Link>
          ...
          <div className="col-md-4 pr-0">
            <div className="loginBox">
              <div className="logo text-center">
                <img src={Logo} width="60px" alt="User Avatar" />
              ...
              <div className="wrapper wrappersignup mt-3 border p-4">
                <form>
                  ...
                  <div
                    className={`form-group mb-3 position-realtive ${
                      inputIndex === 2 && "focus"
                    }`}
                  >
                    <span className="icon">
